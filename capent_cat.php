                ...
                <!--banner area end -->
        <div class="container">
             <h3 id="capentary" class="text-center text-white  bg-primary w-50  ">Capentary</h3>
             <hr>
            <div class="row mt-2">
            ...
            <?php 
               ...
               $sql="select *  from blog where  status='$one' AND category='capentary' order by id desc LIMIT 7 OFFSET 1   ";
