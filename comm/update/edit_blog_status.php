...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE blog SET status='$status' WHERE id='$id2' ";
    $query_run = mysqli_query($conn, $sql);
        
        
    if($query_run){
    echo"<script>alert('Blog deactivated '); window.location='../manage_blogs.php'</script>";
    }
    }
}
      ?>
...
if ($act==0) {
    ...
    $data='0';
      ...
      <?php } ?>
        <a href="../manage_blogs.php"   class=" w-25 btn btn-primary ">Cancel </a>
