    ...
    <div class="modal" id="first-modal" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form class="login  p-2"method="post" enctype="multipart/form-data" action="add/add_bill.php">
      ...
      <div class="tenant-details mt-2  col-sm-12">
        <div class="user-bill text-center rounded shadow p-3  text-white">
          <img class="rounded-circle" style="width: 100px; height:50px ;" src="login/upload/<?php echo $row['image'] ?>" alt="User image">
             ...
             <a href="<?=$link;?>" class="btn btn-bill-detail  bg-success m-1" style="width:60%"><i class="fa fa-money"></i> Make payment</a>
             <button class="btn btn-bill-detail m-1" style="width:60%"><i class="fa fa-download"></i> Download Report</button>
