...
<body>
 ...
 <center>
     <div class="blog-bt">
        ...
        <a href="add_lif.php" type="button" class="btn btn-primary" >Lifestyle</a>
...
<input type="file" class="form-control-file border" name="image">
        ...
        <div class="form-group">
        <label for="pwd">Main category</label>
       <select class=" form-control w-50"name="main_cat" id="cat">
   ...
   <!-- <div class="form-group">
       ...
       <option value="">Select Category</option>
        ...
        <option value="mechanical">DIY</option>
       </select>
      </div> ----->
...
//returns 'does-this-thing-work-or-not'
	...
	if(move_uploaded_file($_FILES["image"]["tmp_name"],'upload/'.$filename)){
		// Image db insert sql
		$sql = "INSERT INTO `blog`( `id_user`,`tittle`,`slug`,`dis`, `content`, `image`, `category`, `fname`,`sname`, `img`, `date`) VALUES (' $id_user,','$tittle','$slug','$dis','$content','$filename','$main_cat','$byF','$byS','$img','$date')";
		if(mysqli_query($conn,$sql)){
      header("Location:update/add_cover_image.php?id=$slug");
		}
		else{
