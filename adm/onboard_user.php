...
.fluid a:last-child {
  margin-right: 0rem;
   ...
   <!--Table-->
   <h5 class='mb-3'>Form confirmation</h5>
...
function create_slug($string){
 ...
 while ($row=mysqli_fetch_array($result)) {
  ...
  $link="delete/del_user.php?id=".urlencode(base64_encode($data));
  $link1="update/view_form.php?id=".urlencode(base64_encode($data));
  $action="update/edit_form_status.php?id=".urlencode(base64_encode($data));
  $dat=$data;
